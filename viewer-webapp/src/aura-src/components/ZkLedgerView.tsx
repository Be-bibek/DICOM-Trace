...
interface ZkLedgerViewProps {
  metadata: ZkProofMetadata;
  scan: DicomScan;
  isBreached: boolean;
}

export const ZkLedgerView: React.FC<ZkLedgerViewProps> = ({
  metadata,
  scan,
  isBreached
}) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto neumo-card p-6 flex flex-col max-h-[90vh] overflow-y-auto">
{/* Header */}
